...
def targeting_packs():
    ...
    targeting_pack(name = "default_net6.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v6.0.33"], target_framework = "net6.0")
    ...
    targeting_pack(name = "default_net8.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v8.0.8"], target_framework = "net8.0")
    targeting_pack(name = "default_net9.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.0-rc.1.24431.7"], target_framework = "net9.0")
    ...
    targeting_pack(name = "web_net6.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v6.0.33", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v6.0.33"], target_framework = "net6.0")
