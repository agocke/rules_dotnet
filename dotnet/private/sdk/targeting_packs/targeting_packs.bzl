...
def targeting_packs():
    ...
    targeting_pack(name = "default_net6.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v6.0.36"], target_framework = "net6.0")
    targeting_pack(name = "default_net7.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v7.0.20"], target_framework = "net7.0")
    targeting_pack(name = "default_net8.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v8.0.26"], target_framework = "net8.0")
    targeting_pack(name = "default_net9.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.15"], target_framework = "net9.0")
    targeting_pack(name = "default_net10.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v10.0.7"], target_framework = "net10.0")
    targeting_pack(name = "default_net11.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v11.0.0-preview.3.26207.106"], target_framework = "net11.0")
    ...
    targeting_pack(name = "web_net6.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v6.0.36", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v6.0.36"], target_framework = "net6.0")
    ...
    targeting_pack(name = "web_net8.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v8.0.26", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v8.0.26"], target_framework = "net8.0")
    targeting_pack(name = "web_net9.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v9.0.15", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.15"], target_framework = "net9.0")
    targeting_pack(name = "web_net10.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v10.0.7", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v10.0.7"], target_framework = "net10.0")
    targeting_pack(name = "web_net11.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v11.0.0-preview.3.26207.106", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v11.0.0-preview.3.26207.106"], target_framework = "net11.0")
